...
void print_words_vector(const WordVec& word_vector);
WordVec task_1_test_driver(const std::string& infilename);
void validate_word_map(const WordMap& wmap);
void print_word_map(const WordMap& wmap);
void task_2_test_driver(const WordVec& words_vector);
void task_3_test_driver(const WordVec& words_vector);
void validate_unique_words_vector(const WordVec& word_vector);
void task_4_test_driver(const WordVec& words_vector);
...
WordVec task_1_test_driver(const std::string& infilename)
{
   ...
   WordVec words_vector = read_words_into_vector(infilename);
...
void task_2_test_driver(const WordVec& words_vector)
{
   ...
   WordMap word_map_using_lambda = map_and_count_words_using_lambda(words_vector);
...
void task_3_test_driver(const WordVec& words_vector)
{
   ...
   WordMap word_map_using_functor = map_and_count_words_using_functor(words_vector);
...
void task_4_test_driver(const WordVec& words_vector)
{
   ...
   WordVec unique_words_vector = remove_duplicates(words_vector);
...
int main()
{
    std::string infilename{ "words.txt" }; // adjust the input file path
